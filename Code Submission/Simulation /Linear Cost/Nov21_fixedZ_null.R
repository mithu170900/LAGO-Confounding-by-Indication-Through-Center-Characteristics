# ==============================================================================
# NULL HYPOTHESIS SIMULATION - FIXED Z_J VERSION
...
eta_1 <- rho_1 / sqrt(1 - rho_1^2)  # = 0.1005
eta_2 <- rho_2 / sqrt(1 - rho_2^2)  # = 0.2041
...
run_single_simulation <- function(sim_id, n1j, n2j, J) {
  ...
  tryCatch({
    # Stage 1 simulation (z_j is fixed across all simulations)
...
# Save results
write.csv(null_results, "Table_NULL_linear_fixed_zj_highconf.csv", row.names = FALSE)
...
cat("\n=== SIMULATION COMPLETE ===\n")
cat("Results saved to: Table_NULL_linear_fixed_zj.csv\n")

# ==============================================================================
# VERIFY FIXED Z_J VALUES
# ==============================================================================
cat("\n=== FIXED Z_J VALUES USED ACROSS ALL SIMULATIONS ===\n")
cat("Z_j values (fixed for all scenarios and simulations):\n")
cat("  First 6 centers:", round(z_j[1:6], 4), "\n")
cat("  First 10 centers:", round(z_j[1:10], 4), "\n")
cat("  All 20 centers:", round(z_j[1:20], 4), "\n")

cat("\nExpected Correlations (based on simulation setup):\n")
cat("Cor(int1, z_j): Target =", round(rho_1, 4), "(η₁ =", round(eta_1, 4), ")\n")
cat("Cor(int2, z_j): Target =", round(rho_2, 4), "(η₂ =", round(eta_2, 4), ")\n")
cat("\nNote: Z_j values are FIXED and identical across all simulation iterations.\n")