# ==============================================================================
# TWO-STAGE SIMULATION - VARYING Z_J VERSION  
...
write.csv(Table1A_intervention_effects, "Table1A_sim_linear_varying_zj_highconf.csv", row.names = FALSE)
write.csv(Table1B_optimization_performance, "Table1B_sim_linear_varying_zj_highconf.csv", row.names = FALSE)
write.csv(Table1C_confidence_and_outcomes, "Table1C_sim_linear_varying_zj_highconf.csv", row.names = FALSE)
...
cat("\n=== SIMULATION COMPLETE ===\n")
cat("All results saved to CSV files with '_varying_zj' suffix\n")
