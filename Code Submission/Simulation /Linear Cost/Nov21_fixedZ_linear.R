# ==============================================================================
# TWO-STAGE SIMULATION - FIXED Z_J VERSION
...
clusterExport(cl, c("beta_true_int1", "beta_true_int2", "beta_z",
                    "eta_1", "eta_2", "z_j",
                    "x_min", "x_max", "x1_rec_stage2", "x2_rec_stage2", "trueXopt"))
...
write.csv(Table1A_intervention_effects, "Table1A_sim_linear_fixed_zj_highconf.csv", row.names = FALSE)
write.csv(Table1B_optimization_performance, "Table1B_sim_linear_fixed_zj_highconf.csv", row.names = FALSE)
write.csv(Table1C_confidence_and_outcomes, "Table1C_sim_linear_fixed_zj_highconf.csv", row.names = FALSE)
...
cat("\n=== SIMULATION COMPLETE ===\n")
cat("All results saved to CSV files with '_fixed_zj' suffix\n")
